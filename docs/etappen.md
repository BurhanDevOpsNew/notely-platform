# Etappen-Log — Notely Platform

> Ausgelagert aus CLAUDE.md (Doctor-Lauf 2026-08-27), damit die Datei nicht in
> jeder Session komplett im Kontext liegt. Inhaltlich unverändert: das Protokoll
> aller Etappen mit Entscheidungen, Beweisen und Fehlerklassen.
